...
public interface UseCase {
  ...
  String JAVA_PATH = System.getProperty("java.home"); // The JRE
  Set<String> DEFAULT_CLASSPATH_ENTRIES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(JAVA_PATH)));
